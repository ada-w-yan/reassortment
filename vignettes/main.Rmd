...
* `fitness_MW`: fitness of PB1 K229R relative to WT (default 0)
* `fitness_WM`: fitness of PA P653L relative to WT (default 1.25)
* `fitness_MM`: fitness of PB1 K229R PA P653L relative to WT (default 0)
...
par_grid$sim_name <- paste0(num2str(par_grid$fitness_WM), "_", par_grid$reassort)
...
Fig. 2
```{r}
par_grid <- expand.grid(fitness_MW = c(0.8, 0.9, 1.1, 1.2), reassort = c(FALSE, TRUE))
par_grid$sim_name <- paste0(num2str(par_grid$fitness_MW), "_", par_grid$reassort)
Map(run_default_pars, fitness_MW = par_grid$fitness_MW, 
    reassort = par_grid$reassort, par_grid$sim_name)
```
...
par_grid$sim_name <- paste0(num2str(par_grid$mutation_prob), "_", par_grid$reassort)
...
par_grid$sim_name <- paste0(num2str(par_grid$MOI), "_", par_grid$reassort)
...
par_grid$sim_name <- paste0(par_grid$MOI_dependent_burst_size, "_", par_grid$reassort)
...
par_grid$sim_name <- paste0(par_grid$choose_strain_by_fitness, "_", par_grid$reassort)
